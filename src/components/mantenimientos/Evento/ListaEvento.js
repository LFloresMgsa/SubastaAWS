                      ...
                      <TableBody>
                        {data.map((item, idx) => (
                          <StyledTableRow item={item} key={`${item.Emp_cCodigo}-${item.Llave}`}>
                            ...
                            <StyledTableCell align="left">{item.Llave}</StyledTableCell>
                            ...
                            <StyledTableCell align="right">{ccyFormat(item.Dvm_nTopeImporte)}</StyledTableCell>
                            <StyledTableCell align="right">{ccyFormat(item.Dvm_nTopeDias)}</StyledTableCell>
